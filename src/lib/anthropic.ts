...
条件:
- 【必須】冒頭で「いつ・どの会議の話か」を必ず伝える。議事録に書かれている開催年月日と回次（例:「2026年7月13日に開かれた第260回の介護給付費分科会」）を、1〜3行目までに自然な会話の中で明示する。音声だけを聴く人が、いつの議論なのか分からないまま聞き進めることがないようにする
- ただし冒頭を事務的な日付の読み上げで終わらせない。**その回がどんな空気の議論だったかを、2人の感想のやり取りで先に伝える**こと。ミスグレーが議事録を読んだ第一印象を投げ、ゴリ編集長がそれを受けて言い換えるか、少し訂正して実際の温度感を示す。例:「訪問介護の話、すごく盛り上がってたみたいですね」→「盛り上がった、というか、かなり緊張感のある議論だったな」。この「思っていたのと少し違う」という差分が、続きを聴きたくさせる。日付・回次はこのやり取りに織り込んで自然に出す
