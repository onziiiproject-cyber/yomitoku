            ...
            <div style={{
              ...
              <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column" }}>
                ...
                <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: "8px" }}>
                  ...
                  <a href="#" style={{ fontSize: "14px", fontWeight: 600, color: "#0D686E", textDecoration: "none", whiteSpace: "nowrap" }}>
                    パスワードをお忘れの方
                  </a>
                </div>
                ...
                <p style={{ textAlign: "center", fontSize: "15px", fontWeight: 400, color: "#A0A0A0", lineHeight: 1.6, marginTop: "26px" }}>
                  アカウントをお持ちでない方は{" "}
                  <a href="/register" style={{ color: "#0D686E", fontWeight: 700, textDecoration: "none" }}>こちら</a>
                </p>
              </form>
            </div>
