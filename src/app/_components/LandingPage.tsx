...
function CtaButton({ label = "ヨミトク購読を始める", big = false, href = "/register" }: { label?: string; big?: boolean; href?: string }) {
  return (
    <a href={href} style={{
...
export default function LandingPage({ ctaHref = "/register" }: { ctaHref?: string }) {
  return (
      ...
      <section style={{
        ...
        <div className="hero-grid" style={{ maxWidth: 1240, margin: "0 auto", padding: "80px 24px 56px", display: "grid", gridTemplateColumns: "1fr 1.2fr", gap: 24, alignItems: "center" }}>
          <div className="hero-copy">
            ...
            <CtaButton big label="ヨミトク購読を始める" href={ctaHref} />
          ...
          <div style={{ maxWidth: 820, margin: "0 auto" }}>
            <div className="pricing-card" style={{
              ...
              <div style={{ textAlign: "center" }}>
                <CtaButton label="ヨミトク購読を始める" href={ctaHref} />
